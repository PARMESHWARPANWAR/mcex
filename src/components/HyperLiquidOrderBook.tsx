...
interface BroadcastMessage {
  type: 'orderbook_update' | 'spread_update' | 'grouping_update' | 'connection_status' | 'leadership_change' | 'leader_resigned';
  data: any;
  timestamp: number;
}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-gray-900 rounded-lg shadow-lg h-96 p-4 border border-gray-800">
              <div className="text-gray-500 text-center pt-32">
                Chart Component (Placeholder)
              </div>
            </div>
            
            <div className="bg-gray-900 rounded-lg shadow-lg h-48 p-4 border border-gray-800">
        ...
        <div className="mt-6">
          <div className="bg-gray-900 rounded-lg shadow-lg h-64 p-4 border border-gray-800">
